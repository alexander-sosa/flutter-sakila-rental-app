  ...
  Widget popup(){
    if(Provider.of<SakilaProvider>(context, listen: false).getLoggedState()) {
      ...
      return PopupMenuButton(
        itemBuilder: (ctx) =>
        [
          PopupMenuItem(child: Text(username), value: '0',),
      ...
      children: [
        GestureDetector(
          ...
          child: Container(
            ...
            child: inCart(film.film_id) ? Center(child: Text("In Cart", style: TextStyle(fontWeight: FontWeight.bold),)) : Image.network("https://picsum.photos/id/${film.film_id}/135"),
          ),
        ),
        Padding(
