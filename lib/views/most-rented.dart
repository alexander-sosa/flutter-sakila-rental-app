...
class MostRented extends StatefulWidget {
  ...
  @override
  _MostRentedState createState() => _MostRentedState();
}
...
class _MostRentedState extends State<MostRented> {
  ...
  Widget build(BuildContext context) {
    // init data
    films = Provider.of<SakilaProvider>(context, listen: true).getMostRented(0);
  ...
  Widget filmsGrid(List<Film> films){
    return Padding(
      ...
      child: Column(
        children: [
          Expanded(flex: 1, child: Text("Most Rented of All Times", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 28.0, color: Colors.pink), textAlign: TextAlign.left,)),
          Expanded(
            flex: 12,
